 ...
 * Wordt door coerceOutgoingEmailHtml in de Class-Models-mailwrapper gezet (800px, header).
 */
exports.AGENDA_DEFAULT_BOOKING_EMAIL_HTML = `<p style="margin:0 0 12px;text-align:left;">Beste {{client_name}},</p>
