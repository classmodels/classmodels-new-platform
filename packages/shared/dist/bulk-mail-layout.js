...
exports.wrapBulkMailHtml = wrapBulkMailHtml;
exports.appendBulkMailTrackingPixel = appendBulkMailTrackingPixel;
const agenda_mail_placeholders_1 = require("./agenda-mail-placeholders");
function escHtml(s) {
    return s
        .replace(/&/g, '&amp;')
        .replace(/</g, '&lt;')
...
function wrapBulkMailHtml(innerHtml, displayName) {
    ...
    return (0, agenda_mail_placeholders_1.coerceOutgoingEmailHtml)(inner);
}
function appendBulkMailTrackingPixel(html, trackingUrl) {
