...
const GENERIC_FIELDS: FieldSeed[] = [
  ...
  ['nr', 'Nr. (huisnummer)', 'text', true, '3', 'Huisnr.', 'above', 35, ''],
  ...
  ['telefoon', 'GSM', 'tel', true, '2', '0498720371', 'above', 55, ''],
  [
    'hoe_terecht',
...
const MODEL_FIELDS: FieldSeed[] = [
  ...
  ['nr', 'Nr. (huisnummer)', 'text', false, '3', 'Huisnr.', 'above', 25, ''],
  ...
  ['telefoon', 'GSM', 'tel', false, '2', '0498720371', 'above', 45, ''],
  [
    'hoe_terecht',
    'Hoe bent u bij ons terecht gekomen?',
    'select',
