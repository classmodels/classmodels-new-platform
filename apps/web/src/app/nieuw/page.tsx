...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.class-models.be/nieuw',
    locale: 'nl_BE',
    type: 'website',
  },
};
    ...
    <NieuwShell portal="home">
        ...
        <div className="nieuw-wrap nieuw-hero-grid">
          ...
          <aside className="nieuw-hero-card">
            ...
            <div className="nieuw-hero-card-body">
              ...
              <Link className="nieuw-btn" href="/nieuw/gasten/model-worden" style={{ marginTop: 18 }}>
                Naar gastenportaal →
              </Link>
            </div>
          </aside>
      ...
      <section className="nieuw-sectie">
        <div className="nieuw-wrap nieuw-cta-band">
          ...
          <div className="nieuw-hero-actions">
            <Link className="nieuw-btn" href="/nieuw/gasten/intake#agenda">
              Intake-gesprek
            </Link>
            <Link className="nieuw-btn" href="/nieuw/gasten/casting#agenda">
              Casting
            </Link>
            <Link className="nieuw-btn" href="/nieuw/gasten/gratis-fotoshoot#agenda">
              Gratis testshoot
